  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-4 pb-16 lg:pt-8 lg:pb-20 relative hero-background overflow-hidden" role="main" aria-labelledby="hero-heading">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-48 h-48 bg-blue-300 rounded-full opacity-60 blur-xl animate-flower-1"></div>
        <div className="absolute top-40 right-20 w-64 h-64 bg-lavender-300 rounded-full opacity-50 blur-2xl animate-flower-2"></div>
        <div className="absolute bottom-32 left-1/4 w-56 h-56 bg-blue-200 rounded-full opacity-65 blur-xl animate-flower-3"></div>
        <div className="absolute top-1/3 right-10 w-44 h-44 bg-lavender-400 rounded-full opacity-55 blur-xl animate-flower-1"></div>
        <div className="absolute bottom-20 right-1/3 w-72 h-72 bg-blue-400 rounded-full opacity-45 blur-2xl animate-flower-2"></div>
        <div className="absolute top-1/2 left-20 w-48 h-48 bg-lavender-200 rounded-full opacity-50 blur-xl animate-flower-3"></div>
        <div className="absolute bottom-40 left-1/2 w-64 h-64 bg-blue-300 rounded-full opacity-60 blur-xl animate-flower-1"></div>
