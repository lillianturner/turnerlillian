  ...
  return (
    <section id="ux-studies" className="py-20" aria-labelledby="ux-studies-heading">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <aside className="glass-card-primary p-8 rounded-xl mt-8" aria-labelledby="ux-button-demo-heading">
          <h3 id="ux-button-demo-heading" className="text-2xl font-semibold mb-6 text-center">Button Color Options</h3>
